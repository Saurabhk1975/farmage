export default function Products(){
  ...
  return (
    <main className='container mx-auto px-4 md:px-6 py-12'>
      <h2 className='text-2xl font-bold text-darkgreen'>Products <span className='bg-red-600 text-white text-xs px-2 py-1 rounded ml-2'>COMING SOON</span></h2>
      <p className='mt-4 text-brown'>Explore our ranges — launching soon. For bulk or export orders, contact <strong>farmagestore@gmail.com</strong>.</p>
