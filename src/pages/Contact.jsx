export default function Contact(){
  return (
    <main className='container mx-auto px-4 md:px-6 py-12'>
      ...
      <p className='mt-4 text-brown'>For trade, bulk or export enquiries email <strong>farmagestore@gmail.com</strong> or  <strong>+91-9662966244, +91-9769157252</strong> or use the form below.</p>
